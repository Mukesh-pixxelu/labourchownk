...
export default function ThekedarPage() {
    ...
    if (done) {
        return (
            <div className="page">
                <div className="card">
                    <h1 className="logo">Thekedar</h1>
                    <p className="sub">Login ho gaya. {phone}</p>
                    <Link href="/thekedar/home" className="btn btn-thekedar">
                        Aage badho
                    </Link>
                </div>
            </div>
    ...
    return (
        <div className="page">
            <div className="card">
                <h1 className="logo">Thekedar login</h1>
                {step == "phone" ? (
                    <>
                        ...
                        <button className="btn btn-thekedar " type="button" onClick={sendOtp}>
                            OTP bhejo
                        </button>
                    </>
                ) : (
                    <>
                        ...
                        {error ? <p className="error">{error}</p> : null}
                        <button className="btn btn-thekedar " type="button" onClick={login}>
                            Login
                        </button>
                    </>
                )}
